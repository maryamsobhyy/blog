			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('allblogs')}}">All Blogs </a></li>
							{{-- <li><a class="slide-item" href="{{route('paidinvoice')}}">Paid Invoices</a></li>
							<li><a class="slide-item" href="{{route('unpaidinvoice')}}">Unpaid Invoices</a></li>
							<li><a class="slide-item" href="{{route('particiallypaidinvoice')}}">Partially paid invoices</a></li>
                            <li><a class="slide-item" href="{{route('archieveinvoice')}}">Archieved invoices</a></li> --}}
					...
					{{-- <li class="slide">
						...
						<ul class="slide-menu">
                            <li><a class="slide-item" href="{{ route('sections') }}">Sections</a></li>
							<li><a class="slide-item" href="{{ route('products') }}">Products</a></li>
